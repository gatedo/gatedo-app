...
let IgentController = class IgentController {
    constructor(igentService) {
        this.igentService = igentService;
    }
    async analyze(body) {
        return this.igentService.analyzeSymptom(body.petId, body.symptom);
    }
    async chat(body) {
        return this.igentService.chatWithVet(body.petId, body.message, body.symptom);
    }
};
