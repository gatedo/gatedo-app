...
const AppShell = () => {
  ...
  return (
    <LayoutWrapper>
      <div className="app-shell bg-[#F8F9FE] min-h-screen flex flex-col relative overflow-x-hidden">
        ...
        <AnimatePresence>
          {isTransitioning && (
            <motion.div 
              ...
              className="fixed inset-0 z-[99999] flex items-center justify-center bg-[#F8F9FE]"
            >
