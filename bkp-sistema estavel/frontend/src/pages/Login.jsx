  ...
  return (
    <div className="min-h-screen bg-[#6158ca] relative overflow-hidden flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="bg-white/100 backdrop-blur-sm w-full max-w-sm rounded-[35px] shadow-2xl relative pt-16 pb-8 px-6 mt-10"
      >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="text-right">
                <button type="button" className="text-xs text-gray-400 hover:text-[#6158ca]">Esqueceu a senha?</button>
            </div>
            ...
            <motion.button 
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-[#6158ca] text-white h-12 rounded-xl font-black shadow-lg shadow-[#6158ca]/30 flex items-center justify-center gap-2 uppercase text-sm tracking-wide disabled:opacity-70"
            >
