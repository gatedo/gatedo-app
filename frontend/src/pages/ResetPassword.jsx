...
export default function ResetPassword() {
  ...
  if (!token) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#9D8FFF] via-[#7865da] to-[#5e42c0] flex items-center justify-center p-4">
        <div className="bg-white rounded-[28px] p-8 max-w-sm w-full text-center shadow-2xl">
          ...
          <button
            ...
            className="w-full bg-gradient-to-br from-[#9D8FFF] via-[#7865da] to-[#5e42c0] text-white h-12 rounded-xl font-black text-sm uppercase tracking-wide"
          >
            Solicitar Novo Link
          </button>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="bg-white rounded-xl px-4 py-3 border border-gray-100 focus-within:border-[#8B4AFF] transition-colors flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="text-gray-400 hover:text-[#8B4AFF] transition-colors flex-shrink-0"
                  >
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-br from-[#936cff] via-[#8b4dff] to-[#682adb] text-white h-12 rounded-xl font-black shadow-lg flex items-center justify-center gap-2 uppercase text-sm tracking-wide disabled:opacity-70"
                >
