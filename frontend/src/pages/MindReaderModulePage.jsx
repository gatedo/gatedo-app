...
const MODULE_KEY = 'mind-reader';
const MOD = MODULE_CONFIG?.[MODULE_KEY] ?? {
  gptsCost: 25, xptReward: 35, xpgReward: 15,
...
export default function MindReaderModulePage() {
  ...
  const handleGenerate = async () => {
    ...
    const STEPS = [
      'Analisando a personalidade felina...',
      'Decifrando os pensamentos secretos...',
      'Compondo o card criativo...',
      'Aplicando arte e humor final...',
    ];
    let si = 0;
    setGenStep(STEPS[0]);
    ...
    try {
      ...
      if (!finalUrl) throw new Error(res.data?.message || 'A IA não retornou o card.');
      ...
      console.error('[MindReader] generate error:', err);
      setError(err?.response?.data?.message || err?.message || 'Erro ao gerar o card.');
    } finally {
  ...
  const handleDownload = () => {
    ...
    a.href = resultUrl;
    a.download = `mente-do-gato-${Date.now()}.jpg`;
    a.target = '_blank';
    a.click();
  };
      ...
      <div className="sticky top-0 z-40 px-4 pt-5 pb-3"
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-sm font-black text-white">Mente do Gato</p>
          </div>
      ...
      <div className="px-4 pt-2 pb-4 space-y-4 max-w-xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="relative z-10 p-5">
            ...
            <h1 className="text-xl font-black text-white leading-tight mb-0.5">🔮 Mente do Gato</h1>
        ...
        <div>
          ...
          <div className="flex items-center gap-1.5 mt-2 px-1">
            <div className="w-1.5 h-1.5 rounded-full"
              style={{ background: catUrl ? C.purple : catUploading ? '#f59e0b' : 'rgba(255,255,255,0.12)' }} />
            <span className="text-[9px] font-bold"
              style={{ color: catUrl ? C.purple : 'rgba(255,255,255,0.22)' }}>
          ...
          <p className="text-[9px] text-white/18 font-medium mt-1.5 text-center">
            Use fotos com o rosto bem visível para melhores resultados
          </p>
        </div>

        {/* Presets */}
        <div>
          <p className="text-[9px] font-black uppercase tracking-[3px] text-white/35 mb-2.5">Tom do pensamento</p>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder={`Ex: pensando que o dono esqueceu de dar ração, estilo ${activePreset.label.toLowerCase()}...`}
        ...
        <motion.button
          ...
          <span className="relative z-10 flex items-center justify-center gap-2">
            {isGenerating ? (
              ...
              <><Sparkles size={16} /> Revelar pensamento — {effectiveCost} GPTS</>
            )}
          </span>
        </motion.button>
          ...
          {resultUrl && (
            <motion.div
              ...
              <div className="relative">
                <img src={resultUrl} alt="Card gerado" className="w-full object-cover" />
              ...
              <div className="p-4 space-y-2" style={{ background: 'rgba(26,16,48,0.95)' }}>
                <div className="flex items-center gap-1.5 mb-3">
                  ...
                  <p className="text-xs font-black text-white">Card criado com sucesso!</p>
                </div>
